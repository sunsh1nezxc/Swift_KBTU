...
let favoriteBook = Book(title: "Рассуждение о методе", author: "Декарт", pages: 400, price: 850)
...
struct Laptop{
    ...
    let repairCount: Int = 0
    let yearPuchased: Int
}


let laptop1 = Laptop(yearPuchased: 2020)
let laptop2 = Laptop(yearPuchased: 2024)
