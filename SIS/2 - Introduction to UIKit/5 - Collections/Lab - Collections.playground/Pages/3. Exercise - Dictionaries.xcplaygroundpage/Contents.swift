...
var dictionary: [String: [String]] = ["Shapes": shapesArray,"Colors": colorsArray]
print(dictionary)
...
if let colors = dictionary["Colors"], !colors.isEmpty {
    print(colors.last!)
} else {
    print("The colors array is empty or doesn't exist.")
}
/*:
