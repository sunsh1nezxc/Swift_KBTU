 ...
 */
var (width, height) : (Int, Int) = (10, 20)
...
let roompPeimeter = (width * 2) + (height * 2)
print(roompPeimeter)
...
let odd : Int = 5
print(even % 2, odd % 2)
//Yes, because any fair number divided by two gives a remainder of 0 and
/*:
