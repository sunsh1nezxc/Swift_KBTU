 ...
 */
let heartRate1 : Double = 62, heartRate2 : Double = 78, heartRate3 : Double = 100, averageHeartRate = (heartRate1 + heartRate2 + heartRate3) / 3; print(averageHeartRate)
 ...
 */
let tempInFahrenheit = 98.6, tempInCelsius = (tempInFahrenheit - 32) * (5.0/9.0);print(tempInCelsius)
