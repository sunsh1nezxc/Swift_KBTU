 ...
 */
let (heartRate1, heartRate2, heartRate3) = (65, 83, 100)
...
let (heartRate1D, heartRate2D, heartRate3D) : (Double, Double, Double) = (65, 83, 100)
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)
//They are different because an Int variable stores integers, while a Double variable stores floating point values.
...
let (steps, goal) : (Double, Double) = (3_467, 10_000)
